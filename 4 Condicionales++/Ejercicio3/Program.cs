...
class Program
{
    static void Main(string[] args)
    {
        ...
        // y si extiende el disco o no (ingresa 1 para extender o 0 para no extender) y calcule y emita por pantalla el monto de la máquina seleccionada.
    ...
    disco = int.Parse(Console.ReadLine());
        ...
        if(disco == 1)
            precio = precio + 300;
        Console.WriteLine("El precio de la compu es: " + precio);
    }
}
